  ...
  return (
    ...
    >
      ...
      <div className='flex justify-center'>
        <div><i className='mx-1 animate-pulse fas fa-heart' /> <a href={siteConfig('LINK') + '/about'} className='underline font-bold text-gray-500 dark:text-gray-300 '>关于本站</a>.<br /></div>
        © {`${copyrightDate}`}
      </div>
